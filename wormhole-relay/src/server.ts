...
import { TransferStore, type StoreOptions } from './store.js';
...
export class RelayServer {
  ...
  private handlePut(req: http.IncomingMessage, res: http.ServerResponse, id: string): void {
    const chunks: Buffer[] = [];
    let size = 0;
  ...
  private handleGet(res: http.ServerResponse, id: string): void {
  ...
  private handleDelete(res: http.ServerResponse, id: string): void {
